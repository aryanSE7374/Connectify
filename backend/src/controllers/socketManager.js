...
export const connectToSocket = (server)=>{
    ...
    io.on("connection", (socket) => {
        ...
        socket.on("chat-message", (data, sender) => {
            ...
            for (const socketId of connections[matchingRoom]) {
        ...
        */
        ...
        /*
            ...
            {
                Important Reminder (Still a Design Flaw)

                Even with this simplification:

                This still assumes one socket = one room
            }
            ...
            Save message in room history
                    ↓
            Emit message to all sockets in that room
        ...
        */
        ...
        socket.on("disconnect", () => {
            ...
            /*  NOTE : 
                diff time -  
                Time user spent connected
                Not used further here
                intended for analytics/logging 
